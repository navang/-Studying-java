...
public class CustomerView extends JPanel 
{
	...
	private void clearTextField() {// 4. 화면 초기화
	...
	public void searchByTel(){
		...
		try {
			...
			JOptionPane.showMessageDialog( null, "번호 검색실패");
		}
	...
	public void searchByName(){
		...
		try {
			Customer vo = dao.selectByName(name);
			tfCustName.setText(vo.getCustName());
			tfCustTel.setText(vo.getCustTel1());
			tfCustTelAid.setText(vo.getCustTel2());
			tfCustAddr.setText(vo.getCustAddr());
			...
			JOptionPane.showMessageDialog( null, "이름 검색실패");
		}
